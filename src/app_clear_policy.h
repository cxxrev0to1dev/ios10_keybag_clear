...
static SBSApplicationTerminationAssertionRef (*SBSApplicationTerminationAssertionCreateWithError)(void *unknown, NSString *bundleIdentifier, int reason, int *outError);
static void (*SBSApplicationTerminationAssertionInvalidate)(SBSApplicationTerminationAssertionRef assertion);
static NSString* (*SBSApplicationTerminationAssertionErrorString)(int error);
